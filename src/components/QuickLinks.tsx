...
const sections = [
    {
        ...
        icon: Smartphone,
        links: [
            { href: '/app/anzhuo', label: 'OKX安卓版', sub: '正版 · 极速安装', icon: Download, accent: '#22c55e' },
        ],
    },
    {
        title: '苹果 iOS',
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/jiaoyisuo', label: '交易所入口', sub: '平台介绍 · 访问入口直达', icon: Building2, accent: '#94a3b8' },
        ],
    },
];
    ...
    return (
        <section className="py-14" style={{ background: 'var(--bg-surface)' }}>
            <div className="max-w-5xl mx-auto px-5">
                <h2 className="section-title text-2xl font-bold mb-8">OKX快速通道</h2>
